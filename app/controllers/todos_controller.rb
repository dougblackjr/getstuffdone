class TodosController < ApplicationController
  before_action :set_todo, only: [:show, :edit, :update, :destroy, :patch]
  ...
  private
    ...
    def todo_params
      params.require(:todo).permit(:title, :description, :priority, :picture, :completed, :completedat, :completedby, :location_id)
    end
end
